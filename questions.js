...
"Ideally, no individual would ever be required to serve any collective expectation.",
...
"Protecting the public’s right to privacy from surveillance and espionage should be a greater priority than using said tools to catch terrorists or criminals."
        ...
        [//4
                    "It is important for us to preserve pride in our traditions and heritage.",

"It is important for families to stick together and uphold unity, even when its members do not get along.",

"Pursuing the goal of raising a family, and a career that helps achieve this goal is more noble than pursuing a child-free life path.",
...
"I care about the standards of decency and purity.",

"It is shameful to purchase something purely based on its luxury status or trendiness.",

"Human body is sacred and shouldn't be mistreated without important reason.",

"Casual sex between people who are not in commited romantic relationships should be heavily discouraged.",
